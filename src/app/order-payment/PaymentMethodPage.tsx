    ...
    <div className="min-h-screen bg-[#09142E] flex items-center justify-center px-4 py-12">
      <div className="max-w-lg w-full text-center">
        ...
        <p className="font-body text-slate-300 text-sm mb-2">
          Transfer the total amount to complete your order
        </p>
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-green-600 hover:bg-green-700 text-white font-heading text-sm font-semibold uppercase tracking-wider rounded-sm transition-all duration-300 ease-in-out no-underline mb-8 w-full sm:w-auto"
        >
