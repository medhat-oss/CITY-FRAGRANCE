...
const ACCOUNT_DETAILS: Record<string, { title: string; number: string }> = {
  vodafone: { title: 'رقم فودافون كاش', number: '01044415982' },
  instapay: { title: 'رقم حساب إنستا باي', number: '01092748940' },
};
  ...
  return (
    <div className="min-h-screen bg-[#09142E] flex items-center justify-center px-4 py-12">
      <div className="max-w-lg w-full text-center">
        ...
        {/* Instructions */}
        <p
          className="font-body text-sm text-slate-300 leading-relaxed mb-8 text-right"
          style={{ lineHeight: '1.8' }}
        >
          {method === 'cod'
            ? 'تقدر ترسل رسالة عبر الواتساب لتأكيد طلبك وبدء الشحن فوراً.'
            : 'يرجى تحويل المبلغ المطلوب إلى الرقم الموضح أعلاه، ثم إرسال لقطة شاشة (إسكرين شوت) لرسالة التأكيد عبر الواتساب لتأكيد طلبك وبدء الشحن فوراً.'}
        </p>
    ...
    <Suspense
      fallback={
        <div className="min-h-screen bg-[#09142E] flex items-center justify-center">
          <p className="text-white font-heading">جاري التحميل...</p>
        </div>
      }
    >
      <SuccessContent />
