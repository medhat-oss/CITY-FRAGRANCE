...
export default function ProductDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  const activeItem = galleryItems[activeImageIndex] || { type: 'image', url: '/images/product-placeholder.png' };
              ...
              <div className="relative w-full h-full">
                {activeItem.type === 'video' ? (
                  ...
                  <Image
                    ...
                    src={imgError[activeImageIndex] ? '/placeholder.png' : activeItem.url}
                    alt={product.name}
                    fill
        ...
        <div className="fixed inset-0 z-[999] bg-black/95 flex items-center justify-center">
          ...
          <div className="relative w-full h-full max-w-5xl max-h-[90vh] mx-auto p-8 flex items-center justify-center">
            {galleryItems[lightboxIndex]?.type === 'video' ? (
              <video
                src={getOptimizedVideoUrl(galleryItems[lightboxIndex].url)}
                autoPlay
                loop
                muted
                playsInline
              ...
              <Image
                src={galleryItems[lightboxIndex]?.url || '/images/product-placeholder.png'}
