...
export default function GlobalError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <html>
      <body style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh', fontFamily: 'sans-serif', padding: 20, textAlign: 'center' }}>
        <h1 style={{ fontSize: '2rem', marginBottom: 8 }}>500</h1>
        <p style={{ color: '#666', marginBottom: 24 }}>Fatal error. Check server logs.</p>
